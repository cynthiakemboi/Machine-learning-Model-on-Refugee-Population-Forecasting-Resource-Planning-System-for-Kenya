...
# The model is configured to run on the CPU.
# Streamlit page settings define the application title,
# browser icon, and layout width.
...
# These functions handle different formats of saved encoders.
AGE_COHORT_PROFILES = {
    "0-4": {
        "school_age": False,
...
# Loads Kenya refugee population records from CSV.
@st.cache_data
...
# Reads saved evaluation results from model_metrics.json.
